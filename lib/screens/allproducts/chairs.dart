...
import '../single_products/singlechair.dart';
                      ...
                      child: InkWell(
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(
                              ...
                              return info(Modelschair: Modelschair[index],);
                          ...
                          child: Container(
                            child: Column(
                              children: [
                                ...
                                Container(
                                  child: Text(
                                    Modelschair[index].subtitle,
                                    style:  constant().stylesubtitle
                                  ),
                                ),
                                Container(
                                  child: Text(
                                    Modelschair[index].price.toString(),
                                ...
                                Row(
                                  children: [
                                    Container(
                                      ...
                                      child: IconButton(
                                        onPressed: () {
                                          Favorite.add(Modelschair[index]);
                                        },
                                        icon: ButtonIcon(
