...
class info extends StatelessWidget {
  final ModelProduct Modelschair;



  const info({Key? key, required this.Modelschair}) : super(key: key);
        ...
        children: [
          Column(
            children: [
              Container(
                height: 350,
                child: Image.asset(Modelschair.image),
              ),
              Row(
                children: [
                  Container(
