...
class SingleAll extends StatelessWidget {
  final ModelProduct Modelsalls;

  // info({required this.Modelschair});

  const SingleAll({Key? key, required this.Modelsalls}) : super(key: key);
        ...
        children: [
          Column(
            children: [
              Container(
                height: 350,
                child: Image.asset(Modelsalls.image),
              ),
              Row(
                children: [
                  Container(
