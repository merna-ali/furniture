...
class SingleTables extends StatelessWidget {
  final ModelProduct Modelstables;


  const SingleTables({Key? key, required this.Modelstables}) : super(key: key);
        ...
        children: [
          Column(
            children: [
              Container(
                height: 350,
                child: Image.asset(Modelstables.image),
              ),
              Row(
                children: [
                  Container(
