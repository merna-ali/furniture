...
class SingleBed extends StatelessWidget {
  final ModelProduct Modelsbeds;

  // info({required this.Modelschair});

  const SingleBed({Key? key, required this.Modelsbeds}) : super(key: key);
        ...
        children: [
          Column(
            children: [
              Container(
                height: 350,
                child: Image.asset(Modelsbeds.image),
              ),
              Row(
                children: [
                  Container(
